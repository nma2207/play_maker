...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        Collection singers = allWork.getInstance().getSingerDAO().getAllSingers(session);
        ...
        while (iterator.hasNext()) {
            ...
            Collection songs = allWork.getInstance().getSongsDAO().getSongsBySinger(singer, session);
        ...
        while (iterator.hasNext()) {
            ...
            Collection songs = allWork.getInstance().getSongsDAO().getSongsByGenre(genre,session);
            Iterator iterator2 = songs.iterator();
            while (iterator2.hasNext()) {
                Songs song = (Songs) iterator2.next();
